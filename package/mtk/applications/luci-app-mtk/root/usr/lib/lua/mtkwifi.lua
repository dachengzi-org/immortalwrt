...
function mtkwifi.detect_6G()
    ...
    for _,dev in ipairs(devs) do
        if tonumber(dev.WirelessMode) == 18 then
            isinclude_6G = true
        end
    end
    return isinclude_6G
