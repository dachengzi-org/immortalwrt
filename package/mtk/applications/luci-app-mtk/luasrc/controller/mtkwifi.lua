...
function apply_wifi_bh_priority(bhPriority2G, bhPriority5GL, bhPriority5GH, bhPriority6G)
    ...
    if is_7800 then is_7800 = 1 else is_7800 = 0 end
    local r = c_apply_wifi_bh_priority(bhPriority2G, bhPriority5GL, bhPriority5GH, bhPriority6G, is_7800)
    if r.status == "SUCCESS" then
        ...
        read_easymesh_cfgs['BhPriority6G'] = bhPriority6G
        ...
        write_easymesh_cfgs['BhPriority6G'] = bhPriority6G
...
function apply_user_preferred_channel(channel, band)
    ...
    local r = c_apply_user_preferred_channel(channel, band, is_7800)
...
function trigger_channel_scan(almac, band)
    ...
    local r = c_trigger_channel_scan(almac, band, is_7800)
...
function apply_channel_utilization_th(channelUtilTh2G, channelUtilTh5GL, channelUtilTh5GH, channelUtilTh6G)
    ...
    local r = c_apply_channel_utilization_th(channelUtilTh2G, channelUtilTh5GL, channelUtilTh5GH, channelUtilTh6G, is_7800)
    if r.status == "SUCCESS" then
        local easymesh_cfgs = mtkwifi.load_profile(mtkwifi.__read_easymesh_profile_path())
        if easymesh_cfgs['CUOverloadTh_2G'] ~= channelUtilTh2G or
           easymesh_cfgs['CUOverloadTh_5G_L'] ~= channelUtilTh5GL or
           easymesh_cfgs['CUOverloadTh_5G_H'] ~= channelUtilTh5GH or
           easymesh_cfgs['CUOverloadTh_6G'] ~= channelUtilTh6G then
            ...
            easymesh_cfgs['CUOverloadTh_6G'] = channelUtilTh6G
            mtkwifi.save_write_easymesh_profile(easymesh_cfgs)
        end
        local easymesh_mapd_cfgs = mtkwifi.load_profile(mtkwifi.__easymesh_mapd_profile_path())
        if easymesh_mapd_cfgs['CUOverloadTh_2G'] ~= channelUtilTh2G or
           easymesh_mapd_cfgs['CUOverloadTh_5G_L'] ~= channelUtilTh5GL or
           easymesh_mapd_cfgs['CUOverloadTh_5G_H'] ~= channelUtilTh5GH or
           easymesh_mapd_cfgs['CUOverloadTh_6G'] ~= channelUtilTh6G then
            ...
            easymesh_mapd_cfgs['CUOverloadTh_6G'] = channelUtilTh6G
            mtkwifi.save_easymesh_mapd_profile(easymesh_mapd_cfgs)
        end
    end
    http.write_json(r)
...
function get_user_preferred_channel()
    local is_7800 = mtkwifi._is_ax7800()
    if is_7800 then is_7800 = 1 else is_7800 = 0 end
    local r = c_get_user_preferred_channel(is_7800)
    http.write_json(r)
end
